<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site1.Master" AutoEventWireup="true" CodeBehind="Fantasia.aspx.cs" Inherits="ProyectoWebPageMaster.GUI.Fantasia" %>
  ...
  <div class="container">
      <div class="row">
          <div class="owl-carousel owl-theme">
               <div class="item">
                  <div class="card">
                      <img src="../recursos/img/Lirbo_Fantasia/El%20don%20de%20los%20anillos.jpg" alt="img" class="card-img-top" />
                      <div class="card-body">
                          <h3>El señor de los anillos</h3>
                          <h5> Autor:<span class="text-center">J.R.R. Tolkien </span></h5>
                          <p>
                              <samll>
              ...
              <div class="item ">
                  <div class="card">
                      <img src="../recursos/img/Lirbo_Fantasia/FYH.jpg" 
                     alt="img" class="card-img-top" />
                      <div class="card-body">
                          <h3>Canción de Fuego y Hielo</h3>
                          <h5> Autor:<span class="text-center">George R. R. Martin</span></h5>
                          <p>
              ...
              <div class="item">
                  <div class="card">
                      <img src="../recursos/img/Lirbo_Fantasia/la-historia-interminable.jpg" 
                       alt="img" class="card-img-top"/>
                      <div class="card-body">
                          <h3>La historia interminable</h3>
                          <h5> Autor:<span class="text-center"> Michael Ende</span></h5>
                          <p>
