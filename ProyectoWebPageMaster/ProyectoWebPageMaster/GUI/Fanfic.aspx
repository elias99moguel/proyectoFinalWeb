<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Site1.Master" AutoEventWireup="true" CodeBehind="Fanfic.aspx.cs" Inherits="ProyectoWebPageMaster.GUI.Fanfic" %>
  ...
  <div class="container">
      <div class="row">
          <div class="owl-carousel owl-theme">
               <div class="item">
                  <div class="card">
                      <img src="../recursos/img/Historia_Corta_Libro/9788420697116.jpg" 
                      alt="img" class="card-img-top" />
                      <div class="card-body">
                          <h3>Bartebly, el escribiente</h3>
                          <h5> Autor:<span class="text-center">Herman Melville</span></h5>
                          <p>
                              <samll>
              ...
              <div class="item ">
                  <div class="card">
                      <img src="../recursos/img/Historia_Corta_Libro/9788420651361.jpg" 
                     alt="img" class="card-img-top" />
                      <div class="card-body">
                          <h3>La metamorfosis</h3>
                          <h5> Autor:<span class="text-center">Franz Kafka</span></h5>
                          <p>
              ...
              <div class="item">
                  <div class="card">
                      <img src="../recursos/img/Historia_Corta_Libro/El%20baile.jpg" 
                       alt="img" class="card-img-top"/>
                      <div class="card-body">
                          <h3>El Baile</h3>
                          <h5> Autor:<span class="text-center">Irène Némirovsky</span></h5>
                          <p>
